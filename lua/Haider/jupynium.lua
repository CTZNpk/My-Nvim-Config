...
function M.set_default_keymaps(buf_id)
	...
	vim.keymap.set("", "<space>[", "<cmd>JupyniumScrollUp<cr>", { buffer = buf_id, desc = "Jupynium scroll up" })
	vim.keymap.set("", "<space>]", "<cmd>JupyniumScrollDown<cr>", { buffer = buf_id, desc = "Jupynium scroll down" })
end
